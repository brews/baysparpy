...
extlinks = {'issue': ('https://github.com/brews/baysparpy/issues/%s', 'GH'),
            'pull': ('https://github.com/brews/baysparpy/pull/%s', 'PR'),
            }
...
htmlhelp_basename = 'baysparpydoc'
...
latex_documents = [
    (master_doc, 'baysparpy.tex', 'baysparpy Documentation',
...
man_pages = [
    (master_doc, 'baysparpy', 'baysparpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'baysparpy', 'baysparpy Documentation',
     author, 'baysparpy', 'One line description of project.',
     'Miscellaneous'),
]
